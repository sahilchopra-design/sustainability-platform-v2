...
- Instrument Summary shows type distribution
- Maturity Profile shows concentration by year
- Green vs Brown classifies instruments by taxonomy alignment
...
8 types: term loan, revolver, bond, CDS, equity swap, mortgage, trade finance, guarantee. Green classification: EU Taxonomy aligned %, ICMA framework.

**Standards:** ['Basel IV', 'EU Taxonomy']
**Reference documents:** Basel IV CRE20; EU Taxonomy Regulation; ICMA Principles
