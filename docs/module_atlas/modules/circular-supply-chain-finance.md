...
- Review 6 circular levers with radar showing impact, cost efficiency, and scalability scores
- Filter and sort 22 companies by circular score, recycled input %, take-back rate, and CE revenue
- Examine 6 cSCF finance instruments with mechanism, provider, min size, and pricing details
- Analyse value leakage map and market maturity trends for circular finance instruments
...
| Dataset | Rows | Fields |
|---|---|---|
| `CIRCULAR_LEVERS` | 7 | `impact`, `cost`, `scalability`, `description`, `examples` |
| `FINANCE_INSTRUMENTS` | 7 | `provider`, `mechanism`, `maturity`, `minSize`, `rate` |
| `VALUE_LEAKAGE` | 7 | `leakagePct`, `capturedPct`, `opportunity` |
| `MATURITY_DATA` | 8 | `pilot`, `scaling`, `mainstream` |
...
|---|---|---|---|
| CE value at stake by 2030 | `Global circular economy opportunity (EMF)` | Ellen MacArthur Foundation 2023 | Largest opportunities in construction ($1.3Tn), food ($700Bn), and mobility ($550Bn) sectors; finance can unlock via cSCF instruments. |
| ING cSCF rate benefit | `Reduction for circular KPI performance` | ING Circular Economy Finance Framework 2023 | Rate benefit tied to 3 KPIs: recycled content %, take-back rate, CE revenue %; annual independent verification required. |
| End-of-life value leakage | `Of product value lost at end of life` | McKinsey CE Value Model 2023 | Contrast: design stage only 8% leakage; addressing end-of-life recovery is single largest circular economy opportunity. |
...
End-of-life stage shows 42% value leakage — highest of any supply chain stage; ING cSCF programmes reduce borrowing cost by 10–40bps for certified circular suppliers.

**Standards:** ['ING Circular Economy Finance Framework 2023', 'ISO 59000 CE Standards 2024', 'EU Circular Economy Action Plan 2020']
**Reference documents:** ING (2023) – Circular Economy Finance Framework; ISO (2024) – ISO 59000 Circular Economy Standards; Ellen MacArthur Foundation (2023) – The Big Opportunity: Capturing the Value of Circularity
