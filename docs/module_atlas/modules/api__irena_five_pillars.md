...
Output: `{'type': 'object', 'keys': ['entity_name', 'entity_type', 'country_iso2', 'assessment_year', 'pillar_results', 'overall_score', 'overall_max', 'overall_pct', 'overall_rating', 'transition_readiness', 'gap_analysis', 'recommendations', 'country_benchmarks'], 'n_keys': 13}`
