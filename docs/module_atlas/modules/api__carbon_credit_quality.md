...
Output: `{'type': 'object', 'keys': ['AM0014', 'AR-ACM0003', 'VM0015', 'VM0007', 'AMS-II.G', 'GS_TPDDTEC', 'ACM0002', 'AMS-I.D', 'ACM0001', 'AMS-III.D', 'AMS-II.C', 'VM0042', 'VM0033', 'VM0024', 'ACR_SCA', 'CAR_IFM', 'GS_ICS', 'ART_TREES', 'VM0041', 'DAC_PILOT'], 'n_keys': 20}`
...
**POST /api/v1/carbon-credit-quality/check-ccp-eligibility** — status `skipped`, provenance ['computed'], source tables: —
Output: `None`

**POST /api/v1/carbon-credit-quality/score-portfolio** — status `failed`, provenance ['computed'], source tables: —
Output: `None`

**POST /api/v1/carbon-credit-quality/score-project** — status `failed`, provenance ['computed'], source tables: —
Output: `None`
