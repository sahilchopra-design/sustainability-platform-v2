...
export default function ClimateLitigationPage() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 1200, margin: '0 auto' }}>
      <div style={{ marginBottom: 24 }}>
        <h1 style={{ fontSize: 24, fontWeight: 700, color: '#1b3a5c', margin: 0 }}>Climate Litigation Risk</h1>
              ...
              <tbody>
                {disclosure.triggers.map((t, i) => (
                  <tr key={i} style={{ borderBottom: '1px solid #f3f4f6' }}>
                    <td style={{ padding: '8px 10px', fontWeight: 500, color: '#1b3a5c', fontSize: 12 }}>{t.trigger}</td>
