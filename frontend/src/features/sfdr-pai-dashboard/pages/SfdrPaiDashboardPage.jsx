...
const PAI_INDICATORS=[
  ...
  {id:'PAI-10',name:'UNGC Violations',metric:'Violations of UNGC principles / OECD MNE guidelines',unit:'%',category:'Social',table:1,assetClass:'company'},
  {id:'PAI-11',name:'Lack of UNGC Processes',metric:'No processes to monitor UNGC compliance',unit:'%',category:'Social',table:1,assetClass:'company'},
