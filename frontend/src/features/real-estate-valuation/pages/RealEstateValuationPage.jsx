...
const PORTFOLIO = Array.from({ length: 30 }, (_, i) => {
  ...
  const names = ['1 Poultry EC2', 'Kings Cross Central', 'MediaCityUK Block A', 'Edinburgh Waverley Gate', 'Brindleyplace B5', 'Harbourside Bristol', 'Canary Wharf TW2', 'Oxford Street 220', 'Piccadilly 45', 'Manchester Spinningfields', 'Victoria Square B'ham', 'St Andrews Square Edin', 'Temple Quay Bristol', 'Broadgate Circle EC2', 'Regent Quarter N1', 'York House Leeds', 'Central Sq Cardiff', 'Angel Square Manc', 'Capital Quarter Cardiff', 'Quartermile Edin', 'Snowhill B'ham', 'Colmore Row B'ham', 'Eldon Square Newcastle', 'The Forum Norwich', 'Arndale Centre Manc', 'One Deansgate', 'Pacific Quay Glasgow', 'Tollcross Edin', 'Temple Meads Bristol', 'Croydon Gateway'];
