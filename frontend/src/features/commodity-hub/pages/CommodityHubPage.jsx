...
/* =================================================================
   ...
   ================================================================= */
const MODULES = [
  { id:'intel', name:'Commodity Intelligence', path:'/commodity-intelligence', icon:'\u{1F4CA}', color:'#0284c7', metrics:{ commodities:50, models:8, accuracy:'94%' }, description:'50-commodity intelligence engine with ML forecasting & geopolitical risk', dataFlows:['Price feeds','Geo-signals','Demand data'], outputsTo:['Hub','MFI','Financial Flow'] },
  { id:'inventory', name:'Global Inventory', path:'/commodity-inventory', icon:'\u{1F30D}', color:'#7c3aed', metrics:{ warehouses:240, tracked:'$2.4T', alerts:18 }, description:'Real-time global commodity inventory tracking & supply chain visibility', dataFlows:['Warehouse data','Shipping','Satellite'], outputsTo:['Hub','ESG VC','Supply Chain'] },
  { id:'lca', name:'LCA Engine', path:'/lifecycle-assessment', icon:'\u{267B}', color:'#16a34a', metrics:{ products:320, categories:14, scope:'Cradle-to-Grave' }, description:'ISO 14040/14044 lifecycle assessment for commodity products', dataFlows:['EPD database','Process LCA','Emission factors'], outputsTo:['Hub','Climate/Nature','EPD Database'] },
  { id:'financial', name:'Financial Flow', path:'/financial-flow', icon:'\u{1F4B0}', color:'#d97706', metrics:{ flows:'$890Bn', externalities:'$142Bn', coverage:'95%' }, description:'Commodity financial flow mapping with externality pricing', dataFlows:['Trade data','Price signals','Carbon markets'], outputsTo:['Hub','MFI','Intelligence'] },
  { id:'esgvc', name:'ESG Value Chain', path:'/esg-value-chain', icon:'\u{1F331}', color:'#5a8a6a', metrics:{ chains:85, tiers:5, risks:342 }, description:'Multi-tier ESG value chain analysis & CSDDD compliance', dataFlows:['Supplier data','ESG ratings','Due diligence'], outputsTo:['Hub','Climate/Nature','Inventory'] },
  { id:'climate', name:'Climate/Nature Repo', path:'/climate-nature-repo', icon:'\u{2603}', color:'#0d9488', metrics:{ ghgMt:1240, waterGl:85, biodiversity:'42 species' }, description:'Climate & nature impact repository: GHG, water, biodiversity', dataFlows:['GHG inventories','Water data','Biodiversity DB'], outputsTo:['Hub','LCA','ESG VC'] },
  { id:'mfi', name:'Multi-Factor Integration', path:'/multi-factor-integration', icon:'\u{1F9E9}', color:'#dc2626', metrics:{ factors:12, signals:890, alpha:'2.8%' }, description:'Integrated commodity factor model: Financial x ESG x Climate', dataFlows:['Factor signals','Alpha models','Risk premia'], outputsTo:['Hub','Intelligence','Financial Flow'] },
  { id:'critical', name:'Critical Minerals', path:'/critical-minerals', icon:'\u{26CF}', color:'#8b5cf6', metrics:{ minerals:22, regions:35, supplyChains:48 }, description:'Critical mineral supply chain mapping & geopolitical risk assessment', dataFlows:['Mining data','Trade flows','Reserve estimates'], outputsTo:['Hub','Intelligence','Inventory'] },
  { id:'product', name:'Product Anatomy', path:'/product-anatomy', icon:'\u{1F52C}', color:'#0891b2', metrics:{ products:180, components:'2.4K', materials:'850' }, description:'Product-level material decomposition & circular economy scoring', dataFlows:['BOM data','Material DB','Recycling rates'], outputsTo:['Hub','LCA','EPD Database'] },
  { id:'dpp', name:'Digital Product Passport', path:'/digital-product-passport', icon:'\u{1F4F1}', color:'#ec4899', metrics:{ passports:420, compliant:'96%', blockchain:'Active' }, description:'EU DPP-compliant digital product passports for supply chain transparency', dataFlows:['Product specs','Compliance data','QR/blockchain'], outputsTo:['Hub','ESG VC','Product Anatomy'] },
];
        ...
        <div style={{ display:'flex', gap:4, justifyContent:'space-between' }}>
          {['Extraction','Processing','Manufacturing','Distribution','Use Phase','End of Life'].map((stage, i) => (
            <div key={stage} style={{ flex:1, textAlign:'center', padding:12, borderRadius:8, background:[T.red+'12',T.amber+'12',T.gold+'12',T.navyL+'12',T.sage+'12',T.green+'12'][i], border:`1px solid ${[T.red,T.amber,T.gold,T.navyL,T.sage,T.green][i]}33`, position:'relative' }}>
              <div style={{ fontSize:20, marginBottom:4 }}>{['\u26CF','\u2699','\u{1F3ED}','\u{1F69A}','\u{1F464}','\u267B'][i]}</div>
