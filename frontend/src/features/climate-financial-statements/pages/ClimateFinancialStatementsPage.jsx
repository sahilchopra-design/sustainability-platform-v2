...
export default function ClimateFinancialStatementsPage() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 1200, margin: '0 auto' }}>
      <div style={{ marginBottom: 24 }}>
        <h1 style={{ fontSize: 24, fontWeight: 700, color: '#111827', margin: 0 }}>Climate Financial Statements (E86)</h1>
                  ...
                  <tbody>
                    {provisionTypes.map((p, i) => (
                      <tr key={i} style={{ borderBottom: '1px solid #f3f4f6' }}>
                        <td style={{ padding: '9px 10px', fontWeight: 500, color: '#111827' }}>{p.name}</td>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 14 }}>
              ...
              <tbody>
                {strandedAssetTypes.map((a, i) => {
                  ...
                  return (
                    <tr key={i} style={{ borderBottom: '1px solid #f3f4f6' }}>
                      <td style={{ padding: '10px 12px', fontWeight: 600, color: '#111827' }}>{a.type}</td>
