...
export default function SovereignSWFPage() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 1200, margin: '0 auto' }}>
      <div style={{ marginBottom: 24 }}>
        <h1 style={{ fontSize: 24, fontWeight: 700, color: '#1b3a5c', margin: 0 }}>Sovereign & SWF ESG Engine</h1>
                ...
                <tbody>
                  {divest.npvTable.map((r, i) => (
                    <tr key={i} style={{ borderBottom: '1px solid #f3f4f6', background: i % 2 === 0 ? 'white' : '#f9fafb' }}>
                      ...
                      <td style={{ padding: '8px 12px', color: '#1b3a5c', fontWeight: 600 }}>{r.npvImpact}</td>
